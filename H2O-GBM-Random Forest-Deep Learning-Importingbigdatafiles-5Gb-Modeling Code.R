...
localH2Oinstance <- h2o.init(ip = "localhost", port ="Enter Port No", startH2O = TRUE ,max_mem_size = "25g" )
...
#file=read.csv("path/Data_file_name.csv")
#Normal read.csv throws an error, as the R environment fails in dealing with huge datasets.

#bigdata.hex = h2o.importFile( path = "path/Data_file_name.csv", destination_frame = "bigdata.hex")
